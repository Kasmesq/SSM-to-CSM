...
//sets up necessary data structures based on the query and data graphs
...
//clears these structures to free resources
...
//navigating through the graph based on various orders and local views to count matching subgraphs. 
...
//calculates local candidates for a vertex at a specific depth, 
//aiding the search process by filtering and refining candidate vertices 
//based on the graph's structure and previous search states.
