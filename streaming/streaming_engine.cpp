...
//Sets up the engine by initializing global and local view managers
// and the search manager with the target number of embeddings.
...
//Frees resources by releasing the view managers and the search manager.
...
//Prepares the data graph and query graph 
//by creating global views and generating processing orders.
...
//Processes an update on the graph, updating global and local views, 
//and optionally performing a search to count matching subgraphs.
...
//Measures the performance impact of updating views in response to graph changes.
...
//Executes the search process on a series of graph updates 
//within a specified time limit, gathering performance metrics.
...
//Displays various performance counters and metrics after the search evaluation.
...
//Loads a stream of updates from a file and prepares them for processing.
...
//Runs the search evaluation within a set time constraint to ensure it completes within the specified limit.
...
//running evaluations, 
//and printing out performance results.