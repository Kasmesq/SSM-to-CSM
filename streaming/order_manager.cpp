...
//Clears all stored data to release resources.
...
//Retrieves order information for a given edge.
...
//Finds automorphism mappings for a specific label triple.
...
//Retrieves edges mapped to a given label triple.
...
//Provides metadata about automorphisms.
...
//Identifies edges involved in automorphisms, 
//helping to recognize symmetrical structures within the graph.
...
//Establishes an indexing order for vertices in a reduced graph, 
//which aids in efficient query processing
...
//Creates a matching order for vertices to optimize subgraph matching.
...
//Utilizes Recursive Induction (RI) to generate a matching order, 
//further refining the matching process.
...
//Generates and associates orders 
//and mappings for efficient graph processing.
...
//Outputs information about the orders and automorphisms 
