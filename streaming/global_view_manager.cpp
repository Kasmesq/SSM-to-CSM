...
//managing gloval views for efficient subgraph matching in streaming context
...
//initialize globalviewmanager by setting up various data structures based on Q
//SM by initial vertex & edge view, setting up NLF mapping, allocate memory for candidates
...
// release(): Cleans up the resources and resets the state of the GlobalViewManager,
// clear everything => no memory leak
...
//create_views(): This function seems to be core to the algorithm, 
//as it likely corresponds to the process of creating views for subgraph matching, 
//a crucial aspect discussed in the paper. 
//It involves constructing views based on the query graph and the data graph,
// which is a fundamental part of the RapidFlow approach.
...
// Retrieving the views and information necessary for subgraph matching
...
//dynamic aspect of the RapidFlow Alg
//1. update based on the change of the graph
//2. key feature in the paper.
...
// can be understood for the algorithm. (debugging purpose)
